...
const DEFAULT_IMAGES = [
  ...
  {
    src: '/fotos/equipo_somosarte.png',
    alt: 'Digital artwork'
  },
  {
    src: '/fotos/arteterapia.png',
    alt: 'Contemporary art'
  },
  {
    src: '/fotos/solista.png',
...
export default function DomeGallery({
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className={`sphere-root relative w-full h-full overflow-hidden ${className}`}
        style={{
          ['--segments-x']: segments,
          ['--segments-y']: segments,
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer bg-neutral-light transition-transform duration-300"
                    role="button"
                    tabIndex={0}
